    ...
    return (
        <footer className="footer">
            ...
            <div className="footer__logo">
                <a href="#" aria-label="Homepage">rene.ux</a>
            </div>
            ...
            <div className="footer__description">
                ...
                <div className="footer__description-goals">
                    <p class="description">
                        Diseño experiencias digitales centradas en el usuario, transformando conceptos en soluciones prácticas.
            ...
            <p className="footer__copy">{'\u00A9'} rene.ux 2024 | Todos los derechos reservados</p>
        </footer>
    );
};
